defmodule GlobalchatWeb.MessageLiveTest do
  use GlobalchatWeb.ConnCase

  import Phoenix.LiveViewTest
  import Globalchat.ChatFixtures

  @create_attrs %{user: "some user", content: "some content"}
  @update_attrs %{user: "some updated user", content: "some updated content"}
  @invalid_attrs %{user: nil, content: nil}
